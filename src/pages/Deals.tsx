...
const savedDeals: Opportunity[] = [
  ...mockOpportunities.slice(2, 5).map(deal => ({
    ...deal,
    matchScore: Math.random() * 0.6 + 0.3,
    matchExplanation: "Matched based on sector and stage preferences"
  }))
];

const pastDeals: Opportunity[] = [
  ...mockOpportunities.slice(5, 7).map(deal => ({
    ...deal,
    stage: "Closed",
    fundingAmount: deal.fundingAmount * 1.2
  }))
];
