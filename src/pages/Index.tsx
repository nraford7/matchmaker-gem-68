      ...
      <div className="relative bg-gradient-to-br from-indigo-50 via-white to-blue-50">
        ...
        <div className="container mx-auto py-16 md:py-24">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="font-medium text-muted-foreground mb-10 text-lg">Brought to you by:</h2>
            
            <p className="text-xl text-muted-foreground max-w-2xl mb-10"> Home to the most successful investors, family offices & funds.</p>
