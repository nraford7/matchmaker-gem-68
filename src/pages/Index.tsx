  ...
  return <div className="relative overflow-x-hidden">
      <div className="relative bg-[#0B0B0B] min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {Array.from({
          length: 50
        }).map((_, i) => <div key={i} className="star absolute rounded-full bg-ivory/80" style={{
        ...
        <div className="container mx-auto px-6 py-24 md:py-32 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-16 mb-16 max-w-3xl">
              <img src="/lovable-uploads/e33a00a9-24d5-4673-ab73-5b76d5d26d3d.png" alt="Emirates Family Office Association" className="h-14 w-auto bg-white p-2 rounded-md" />
              <img src="/lovable-uploads/bc7f0867-82b2-4c0c-acb3-f2093e96736f.png" alt="Abu Dhabi Investment Office" className="h-14 w-auto bg-white p-2 rounded-md" />
              <img src="/lovable-uploads/1c565d4e-6fdd-4731-bb38-e49923afff82.png" alt="EMIR" className="h-14 w-auto bg-white p-2 rounded-md" />
            </div>
          ...
          <div className="container mx-auto py-32">
            ...
            }].map((section, index) => <div key={index} className="rounded-2xl border border-champagne/10 bg-[#0B0B0B] backdrop-blur-sm p-10 shadow-sm transition-all duration-300 hover:shadow-md">
