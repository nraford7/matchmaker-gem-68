...
const Index = () => {
  return <div className="relative bg-background min-h-screen">
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl animate-fade-in">
          <h1 className="font-serif text-6xl md:text-7xl tracking-wider text-foreground mb-8">
            The Guild
          </h1>
          ...
          <div className="space-y-6 mb-16">
            ...
            <div className="flex gap-8 items-center">
              <img src="/lovable-uploads/e33a00a9-24d5-4673-ab73-5b76d5d26d3d.png" alt="Emirates Family Office Association" className="h-8 opacity-75 transition-opacity hover:opacity-100" />
              <img src="/lovable-uploads/bc7f0867-82b2-4c0c-acb3-f2093e96736f.png" alt="Abu Dhabi Investment Office" className="h-8 opacity-75 transition-opacity hover:opacity-100" />
              <img src="/lovable-uploads/1c565d4e-6fdd-4731-bb38-e49923afff82.png" alt="EMIR" className="h-8 opacity-75 transition-opacity hover:opacity-100" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            features: ["Invitation-only access to top-tier deals", "End-to-end encryption for sensitive materials", "Verified investor network with NDA protection"]
          }, {
            ...
            features: ["Intuitive preference profile building", "Contextual understanding of investment goals", "Continuous learning from your feedback"]
          }].map((section, index) => <div key={index} className="rounded-xl border border-border bg-card p-8 transition-all duration-300 hover:border-primary/30 hover:shadow-lg">
                ...
                <ul className="space-y-3 font-serif">
                  {section.features.map((feature, idx) => <li key={idx} className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 bg-card border border-border rounded-xl p-8 w-full transition-all duration-300 hover:border-primary/30 hover:shadow-lg">
            ...
            value: "3,200+",
            label: "Investors"
          }].map((stat, index) => <div key={index} className="transform transition-all duration-500 hover:scale-105">
