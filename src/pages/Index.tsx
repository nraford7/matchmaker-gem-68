      ...
      <div className="relative bg-gradient-to-br from-indigo-50 via-white to-blue-50">
        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl md:text-3xl font-medium text-muted-foreground/90 mb-16 max-w-2xl">
              The UAE's most exclusive investment club for the region's most successful investors
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-16 mb-16 max-w-3xl">
              <img 
                ...
                className="h-14 w-auto grayscale opacity-70 hover:opacity-100 transition-all duration-300" 
              />
              <img 
