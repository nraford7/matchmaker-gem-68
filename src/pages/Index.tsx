      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl animate-fade-in">
          <div className="space-y-8">
            ...
            <h2 className="font-serif text-xl md:text-2xl text-muted-foreground max-w-2xl font-thin tracking-wide leading-relaxed">
          ...
          <div className="mt-16">
            ...
            <div className="flex flex-wrap gap-8 max-w-3xl transition-all duration-500">
              <img src="/lovable-uploads/e33a00a9-24d5-4673-ab73-5b76d5d26d3d.png" alt="Emirates Family Office Association" className="h-16 w-auto bg-white/95 p-3 rounded-lg shadow-sm transition-all duration-300 hover:bg-white hover:scale-105" />
              <img src="/lovable-uploads/bc7f0867-82b2-4c0c-acb3-f2093e96736f.png" alt="Abu Dhabi Investment Office" className="h-16 w-auto bg-white/95 p-3 rounded-lg shadow-sm transition-all duration-300 hover:bg-white hover:scale-105" />
              <img src="/lovable-uploads/1c565d4e-6fdd-4731-bb38-e49923afff82.png" alt="EMIR" className="h-16 w-auto bg-white/95 p-3 rounded-lg shadow-sm transition-all duration-300 hover:bg-white hover:scale-105" />
            </div>
          </div>
